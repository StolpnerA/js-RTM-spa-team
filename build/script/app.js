...
(function e(t, n, r) {
  function s(o, u) {
      ...
      var indexPage = function () {
        ...
        _createClass(indexPage, [{
          ...
          value: function renderPage() {
            ...
            placeRender.innerHTML = "<div class=\"signIn\">\n    <a href=\"https://slack.com/oauth/authorize?scope=chat:write:user emoji:read channels:history channels:write channels:read \n            files:write:user groups:history groups:read groups:write usergroups:read users.profile:read users.profile:write users:write users:read mpim:history mpim:read mpim:write&client_id=217857254422.216894611363\">\n        <img src=\"slackIcon.png\" class=\"slackIcon\"/>\n    </a>\n</div>";
          }
        }]);
      ...
      var mainPage = function () {
        ...
        _createClass(mainPage, [{
          ...
          value: function loadhistoryMessage() {
            ...
            var channel = localStorage.getItem("channel");
            var img = void 0;
            fetch("https://slack.com/api/users.info?token=xoxp-217857254422-218064503559-218076003351-7061300063ff067c4fe861b59a19bcba&user=U6E1WETGF&pretty=1").then(function (response) {
              return response.json();
            }).then(function (data) {
    ...
    }).call(this, require("e/U+97"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_c0fecbb9.js", "/");
