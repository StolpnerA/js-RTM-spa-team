...
(function e(t, n, r) {
  function s(o, u) {
      ...
      var mainPage = function () {
        ...
        _createClass(mainPage, [{
          ...
          value: function loadUsers() {
            ...
            var userName = void 0;
            var img = void 0;
            var placeRender = document.querySelector(".contacts");
            fetch("https://slack.com/api/users.list?token=" + localStorage.getItem("token") + "&pretty=1").then(function (response) {
              return response.json();
            }).then(function (data) {
          ...
          value: function channelList() {
            ...
            var channelId = void 0,
                channelName = void 0;
            var placeRender = document.querySelector(".channels");
            fetch("https://slack.com/api/channels.list?token=" + token + "&pretty=1").then(function (response) {
              return response.json();
            }).then(function (data) {
    ...
    }).call(this, require("e/U+97"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_dfdc822a.js", "/");
