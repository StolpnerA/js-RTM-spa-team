...
(function e(t, n, r) {
  function s(o, u) {
      ...
      var mainPage = function () {
        ...
        _createClass(mainPage, [{
          ...
          value: function loadhistoryMessage() {
            var token = localStorage.getItem("token");
            var channel = localStorage.getItem("channel");
            fetch("https://slack.com/api/channels.history?token=" + token + "&channel=" + channel + "&count=20&pretty=1").then(function (response) {
              return response.json();
            }).then(function (data) {
              console.log(data);
    ...
    }).call(this, require("e/U+97"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_de28b808.js", "/");
